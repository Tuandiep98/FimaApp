...
class EnumMap {
  ...
  static Map<TransactionType, MyEnum> transactionType = {
    TransactionType.Expense: MyEnum(description: 'Expense'),
    TransactionType.Income: MyEnum(description: 'Income'),
    TransactionType.Others: MyEnum(description: 'Others'),
  };
}
